...
Now fire up the SoC!
When at the U-boot prompt, press Ctrl+C to interrupt. It will show "Light LPI4A#"
Type loady 0x200000 , this will start the ymodem protocol to transfer the file directly to the TH1520 at address
0x200000
The Serial Monitor will send C C C at regular interval, this is normal and expected.
Now press Ctrt+A S -> ymodem then navigate to "hello_boot.bin" and send it to the TH1520.
Run go 0x200000.
